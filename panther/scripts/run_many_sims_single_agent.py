...
if __name__ == '__main__':
    ...
    os.system("sed -i '/basis/s/^/#/g' $(rospack find panther)/param/panther.yaml") #comment basis param
    ...
    for k in range(len(total_num_of_obs)):
        for j in range(len(all_basis)):
            ...
            for s in range(num_of_sims):
                ...
                commands.append("sleep 1.0 &&rosrun panther dynamic_corridor.py "+str(total_num_of_obs[k]));
                commands.append("sleep 3.0 && rosparam set /SQ01s/panther/basis "+basis); #Remember to comment the parameter "basis" in panther.yaml before running this file
                ...
                commands.append("sleep 5.0 && roslaunch panther panther.launch");
    ...
    os.system("sed -i '/basis/s/^#//g' $(rospack find panther)/param/panther.yaml") #comment out basis param
