...
class FakeSim:
    ...
    def __init__(self, total_num_obs):
       ...
       #self.num_of_objects = 0;
        ...
        available_meshes_static=["package://panther/meshes/ConcreteDamage01b/model3.dae", "package://panther/meshes/ConcreteDamage01b/model2.dae"]
        available_meshes_dynamic=["package://panther/meshes/ConcreteDamage01b/model4.dae"]
        # available_meshes=["package://panther/meshes/ConcreteDamage01b/model3.dae"]
