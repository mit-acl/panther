...
def convertToStringCommand(action,quad,x,y,z,goal_x,goal_y,goal_z, yaw):
    if(action=="start"):
        return "roslaunch panther panther_specific.launch gazebo:=false quad:="+quad+" x:="+str(x)+" y:="+str(y)+" z:="+str(z)+" yaw:="+str(yaw);
    if(action=="send_goal"):
    ...
    if(action=="panther"):
        return "roslaunch panther panther.launch quad:="+quad #+ " >> "+quad+".txt"
        # return "script -q -c 'roslaunch panther panther.launch quad:="+quad + "' "+quad+".txt"
...
if __name__ == '__main__':
    ...
    #     print ("goal_x= ",goal_x)
    #     if(sys.argv[1]=="start"):
    #         commands.append("roslaunch panther panther_specific.launch gazebo:=false quad:="+quad+" x:="+str(x)+" y:="+str(y)+" z:="+str(z)+" yaw:="+str(yaw))
    #     if(sys.argv[1]=="send_goal"):
    ...
    #     if(sys.argv[1]=="panther"):
    #         commands.append("roslaunch panther panther.launch quad:="+quad)
