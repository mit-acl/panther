...
// https://github.com/casadi/casadi/blob/752695adf24e0d4c904cc0bbeeedbcb73025559d/docs/examples/cplusplus/cmake_pkgconfig/casadi_demo.cpp
...
int main()
{
  ...
  Function tmp = Function::load("./../matlab/my_function.casadi");
